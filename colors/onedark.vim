...
call s:h("MatchParen", { "fg": s:black, "bg": s:white, "gui": "underline" }) " The character under the cursor or just before it, if it is a paired bracket, and its match.
...
"call s:h("javaScriptType", { "fg": s:red })
"call s:h("javaScriptLabel",{ "fg": s:white })
"call s:h("javaScriptNull", { "fg": s:dark_yellow })
"call s:h("javaScriptHtmlEvents", { "fg": s:yellow })
"call s:h("javaScriptDomElemFuncs", { "fg": s:yellow })
"call s:h("javaScriptHtmlElemAttrs", { "fg": s:yellow })
"call s:h("javaScriptHtmlElemFuncs", { "fg": s:yellow })
"call s:h("javaScriptGlobalObjects", { "fg": s:yellow })

" https://github.com/pangloss/vim-javascript
call s:h("jsArrowFunction", { "fg": s:purple })
call s:h("jsBuiltins", { "fg": s:yellow })
...
call s:h("javascriptClassKeyword", { "fg": s:yellow })
...
call s:h("javascriptMethodName", { "fg": s:blue })
call s:h("javascriptObjectLabel", { "fg": s:white })
call s:h("javascriptOpSymbols", { "fg": s:white })
call s:h("javascriptPropertyName", { "fg": s:green })
call s:h("javascriptTemplateSB", { "fg": s:dark_red })
call s:h("javascriptVariable", { "fg": s:purple })
call s:h("javascriptBrackets", { "fg": s:white })
call s:h("javascriptClassName", { "fg": s:blue })
call s:h("javascriptPropertyNameString", { "fg": s:green })
call s:h("javascriptLabel", {"fg": s:red }) 
call s:h("javascriptObjectMethodName", {"fg": s:blue }) 
call s:h("javascriptLineComment", {"fg": s:comment_grey }) 
